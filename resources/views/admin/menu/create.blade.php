                    ...
                    <form action="{{ route('menu.save')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="numerical_order">
                            </div>
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" name="turn_off" value="{{old('turn_off')}}" class="custom-control-input" id="customSwitch1">
