                        ...
                        <div id="date-fields" style="display: none;">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="type" name="type_of_vacation"
                                    ...
                                    <option value="">Chọn loại đề xuất</option>
                                    @foreach ($type_of_vacations as $item)
                                    <option value="{{ $item->name }}">{{ $item->name }}</option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- Hiển Thị -->
                    <div class="modal fade" id="showFormModal-{{ $value->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="showFormModalLabel-{{ $value->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body bg-light">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8 text-dark">
                                            {{ $value->reviewer->name ?? 'Chưa chỉ định' }}
                                        </div>
                                    </div>
